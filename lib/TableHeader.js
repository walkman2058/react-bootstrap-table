...
var _AutoAffix = require('react-overlays/lib/AutoAffix');
  ...
  _createClass(TableHeader, [{
    ...
    value: function render() {
      ...
      if (this.props.stickyHeaders) {
        return _react2.default.createElement(
          _AutoAffix2.default,
          { affixStyle: this.props.affixStyle, container: function container() {
...
TableHeader.propTypes = {
  ...
  autoAffixContainer: _react.PropTypes.object,
  stickyHeaders: _react.PropTypes.bool,
  affixStyle: _react.PropTypes.object
};
